                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{ Auth::user()->anhdaidien }}">
                            <span class="username">
                                {{ Auth::user()->name }}
                            </span>
                            <b class="caret"></b>
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li>
                            <a href="{{ URL::to('/admin/all_faculty') }}">
                                <i class="lnr lnr-tag"></i>
                                <span>Quản lý khoa</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/admin/all_class') }}">
                                <i class="lnr lnr-book"></i>
                                <span>Quản lý lớp<p></p></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/admin/all_student') }}">
                                <i class="lnr lnr-users"></i>
                                <span>Quản lý sinh viên</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/admin/all_subject') }}">
                                <i class="lnr lnr-users"></i>
                                <span>Quản lý môn học</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/admin/all_lecturer') }}">
                                <i class="lnr lnr-users"></i>
                                <span>Quản lý giảng viên</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('/admin/all_point') }}">
                                <i class="lnr lnr-users"></i>
